...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#030712] flex">
      ...
      <div className="flex-1 flex flex-col justify-center items-center px-6 relative py-12">
        {/* Mobile Logo */}
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            <button className="flex-1 flex items-center justify-center gap-2 py-2.5 px-4 rounded-xl border border-gray-200 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-900 transition-colors font-medium text-sm">
